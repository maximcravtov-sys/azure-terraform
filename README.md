...
This project includes Azure DevOps pipeline configurations for automated deployments:

### Quick Start
1. See `AZURE-DEVOPS-QUICK-START.md` for 5-minute setup
2. Or see `AZURE-DEVOPS-SETUP.md` for detailed instructions

### Pipeline Files
- `azure-pipelines-simple.yml` - Simple file deployment (recommended to start)
- `azure-pipelines.yml` - Full build + deploy pipeline
- `azure-pipelines-terraform.yml` - Infrastructure + application deployment

### Features
- ✅ Automated deployments on code push
- ✅ Deploys to all VM instances automatically
- ✅ Works with autoscaling (new VMs get files automatically)
- ✅ IIS restart on all instances
- ✅ Deployment verification

## Next Steps

- Deploy your web application to IIS
- Set up Azure DevOps CI/CD pipelines (see `AZURE-DEVOPS-QUICK-START.md`)
